export const objectsList = [
    { description: 'Le bouclier: +2 points en défense.', link: '../../../assets/objects/Shield.png', isDragAndDrop: false },
    {
    ...
    { description: 'La roue: +2 points en rapidité si tu te trouves sur une case gazon.', link: '../assets/objects/Wheel.png', isDragAndDrop: false },
