...
describe('ItemService', () => {
    ...
    describe('handleItemDiscard', () => {
        it('should remove item and apply removeEffect when item has no condition', () => {
            ...
            expect(eventsGateway.addEventToSession).toHaveBeenCalledWith(sessionCode, `${mockPlayer.name} a jeté un shield et a ramassé un potion`, [
                'everyone',
            ]);
            expect(mockServer.to).toHaveBeenCalledWith(sessionCode);
        ...
        it('should call removeWheelEffect when discardedItem is wheel', () => {
            ...
            (ObjectsEnumsConstants.objectsProperties as unknown)['wheel'] = {
        ...
        it('should return early if discardedItem equals pickedUpItem', () => {
            ...
            (ObjectsEnumsConstants.objectsProperties as unknown)['potion'] = {
        ...
        describe('handleItemPickup', () => {
            it('should add item to inventory if space is available', () => {
                ...
                expect(eventsGateway.addEventToSession).toHaveBeenCalledWith(sessionCode, `${mockPlayer.name} a ramassé un Sword`, ['everyone']);
