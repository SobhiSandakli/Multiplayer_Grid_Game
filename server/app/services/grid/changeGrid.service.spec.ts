...
describe('ChangeGridService', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ChangeGridService,
        { provide: MovementService, useValue: { calculateAccessibleTiles: jest.fn() } },
      ],
    }).compile();
  ...
  describe('changeGrid', () => {
    it('should assign players to starting points and update positions', () => {
      const grid = [
        [{ images: ['assets/objects/started-points.png'], isOccuped: false }, { images: [], isOccuped: false }],
        [{ images: [], isOccuped: false }, { images: ['assets/objects/started-points.png'], isOccuped: false }],
      ];
    ...
    it('should remove excess starting points if there are more points than players', () => {
      const grid = [
        [{ images: ['assets/objects/started-points.png'], isOccuped: false }, { images: [], isOccuped: false }],
        [{ images: ['assets/objects/started-points.png'], isOccuped: false }, { images: ['assets/objects/started-points.png'], isOccuped: false }],
      ];
  ...
  describe('moveImage', () => {
    it('should move an image from the source tile to the destination tile', () => {
      const grid = [
        [{ images: ['avatar.png'], isOccuped: false }, { images: [], isOccuped: false }],
