...
describe('MovementService', () => {
  ...
  it('should calculate accessible tiles for a player in an open area', () => {
    const grid = [
      [{ images: ['assets/tiles/Grass.png'], isOccuped: false }, { images: ['assets/tiles/Grass.png'], isOccuped: false }],
      [{ images: ['assets/tiles/Grass.png'], isOccuped: false }, { images: ['assets/tiles/Grass.png'], isOccuped: false }],
    ];
    ...
    expect(player.accessibleTiles).toEqual(
      expect.arrayContaining([
        ...
        },
        {
          ...
          path: [{ row: 0, col: 0 }, { row: 1, col: 0 }, { row: 1, col: 1 }],
        },
      ]),
    );
  });
  ...
  it('should calculate the correct movement cost to a destination', () => {
    const grid = [
      [{ images: ['assets/tiles/Grass.png'], isOccuped: false }, { images: ['assets/tiles/Water.png'], isOccuped: false }],
      [{ images: ['assets/tiles/Grass.png'], isOccuped: false }, { images: ['assets/tiles/Grass.png'], isOccuped: false }],
    ];
  ...
  it('should handle a player surrounded by walls', () => {
    const grid = [
      [{ images: ['assets/tiles/Wall.png'], isOccuped: false }, { images: ['assets/tiles/Wall.png'], isOccuped: false }],
      [{ images: ['assets/tiles/Wall.png'], isOccuped: false }, { images: ['assets/tiles/Grass.png'], isOccuped: false }],
    ];
  ...
  it('should throw an error if destination is not accessible', () => {
    const grid = [
      [{ images: ['assets/tiles/Grass.png'], isOccuped: false }, { images: ['assets/tiles/Wall.png'], isOccuped: false }],
      [{ images: ['assets/tiles/Grass.png'], isOccuped: false }, { images: ['assets/tiles/Grass.png'], isOccuped: false }],
    ];
